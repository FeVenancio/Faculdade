...
import java.util.Scanner;
    public class Ac2 {
        public static void main(String[] args){
            ...
            char escolha = 's';
            double nota1, nota2, nota3, nota4, mediaAluno, notaMaxima = 0.0;
            int i = 0;
            ...
            while(i < numDeAlunos && escolha == 's'){
                ...
                System.out.println("prova 1: " + " peso : " + peso1 + " nota: " +
                nota1);
                System.out.println("prova 2: " + " peso : " + peso2 + " nota: " +
                nota2);
                System.out.println("prova 3: " + " peso : " + peso3 + " nota: " +
                nota3);
                System.out.println("prova 4: " + " peso : " + peso4 + " nota: " +
                nota4);
                ...
                double porcentagemAprovados = (numDeAprovados + numDeAprovadosCom5 +
                numDeExcelencia) * 100 / listaAlunos.length;
                double porcentagemReprovados = numDeReprovados * 100 /
                listaAlunos.length;
                double porcentagemRecuperacao = numDeRecuperacao * 100 /
                listaAlunos.length;
